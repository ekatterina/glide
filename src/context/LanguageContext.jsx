...
const translations = {
  en: {
    ...
    layerOsm: 'Permanent obstacles',
    layerConstruction: 'Active construction',
    layerReports: 'Community reports',
    toggleObstructions: 'Show all obstructions',
    toggleObstructionsShort: 'Layers',
    routeBest: 'Best',
    routeAlt: 'Alt',
    scoreBreakdownAria: 'Open score breakdown',
    scoreBreakdownTitle: 'How this score was built',
    scoreBreakdownIntro: 'Score {score}/100 — higher means smoother surface, fewer rough patches per metre.',
    scorePathTypeLabel: 'Path types on this route',
    scorePenaltiesLabel: 'Penalties applied',
    osm_cobblestone: 'Cobblestones',
    osm_steps: 'Steps',
    osm_wheelchair_no: 'Wheelchair=no',
    osm_narrow: 'Narrow paths',
    osm_barriers: 'Barriers',
    osm_steep: 'Steep ways',
    wior_active: 'Active works',
    cat_parked_bikes: 'Parked bikes',
    cat_broken_pavement: 'Broken pavement',
    cat_scaffolding: 'Scaffolding',
    cat_parked_car: 'Car on sidewalk',
    cat_flood: 'Flooded',
    cat_trash: 'Trash / bins',
    ...
    reportAnalyzing: 'Claude is analysing the photo…',
    reportAnalyzingHint: 'Vision model classifies the obstruction and writes a description.',
    reportVerdictLabel: 'AI verdict',
    reportStatSeverity: 'Severity',
    reportStatConfidence: 'Confidence',
    reportStatLocation: 'Location',
    reportLocationGps: 'GPS',
    reportLocationApprox: 'Approx.',
    severity_high: 'High',
    ...
    reportErrorTitle: 'Something went wrong',
    reportErrorGeneric: 'We could not analyse the photo. Check your connection and try again.',
    reportSuccessTitle: 'Added to the map.',
    reportSuccessText: 'Thank you for making Amsterdam more accessible.',
    reportSuccessReturning: 'Returning to map…',
  },
  ...
  nl: {
    ...
    layerOsm: 'Vaste obstakels',
    layerConstruction: 'Actieve werken',
    layerReports: 'Meldingen',
    toggleObstructions: 'Toon alle obstakels',
    toggleObstructionsShort: 'Lagen',
    routeBest: 'Beste',
    routeAlt: 'Alt',
    scoreBreakdownAria: 'Score-uitleg openen',
    scoreBreakdownTitle: 'Zo is deze score opgebouwd',
    scoreBreakdownIntro: 'Score {score}/100 — hoger betekent gladder oppervlak en minder ongelijke stukken per meter.',
    scorePathTypeLabel: 'Padtypes op deze route',
    scorePenaltiesLabel: 'Toegepaste straffen',
    osm_cobblestone: 'Keienbestrating',
    osm_steps: 'Trappen',
    osm_wheelchair_no: 'Rolstoel=nee',
    osm_narrow: 'Smalle paden',
    osm_barriers: 'Barrières',
    osm_steep: 'Steile delen',
    wior_active: 'Actieve werken',
    cat_parked_bikes: 'Geparkeerde fietsen',
    cat_broken_pavement: 'Kapot wegdek',
    cat_scaffolding: 'Steiger',
    cat_parked_car: 'Auto op stoep',
    cat_flood: 'Plas / wateroverlast',
    cat_trash: 'Vuilnis / containers',
    ...
    reportAnalyzing: 'Claude analyseert de foto…',
    reportAnalyzingHint: 'Het vision-model classificeert de obstructie en schrijft een beschrijving.',
    reportVerdictLabel: 'AI-oordeel',
    reportStatSeverity: 'Ernst',
    reportStatConfidence: 'Zekerheid',
    reportStatLocation: 'Locatie',
    reportLocationGps: 'GPS',
    reportLocationApprox: 'Ongeveer',
    severity_high: 'Hoog',
    severity_medium: 'Middel',
    severity_low: 'Laag',
    reportConfirm: 'Bevestig & meld',
    reportSaving: 'Opslaan…',
    reportCancel: 'Annuleer',
    reportRetry: 'Opnieuw',
    reportErrorTitle: 'Er ging iets mis',
    reportErrorGeneric: 'We konden de foto niet analyseren. Controleer je verbinding en probeer opnieuw.',
    reportSuccessTitle: 'Toegevoegd aan de kaart.',
    reportSuccessText: 'Bedankt voor het toegankelijker maken van Amsterdam.',
    reportSuccessReturning: 'Terug naar kaart…',
  },
};
